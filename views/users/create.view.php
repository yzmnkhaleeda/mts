...
<main>
    <div class="mx-auto max-w-7xl py-6 sm:px-6 lg:px-8">
        <div class="mx-auto max-w-4xl">
            <form action="/register" method="POST" class="space-y-12">
                ...
                <div class="border-b border-gray-400 pb-12">
                    <h1 class="text-base/7 font-semibold text-gray-900">User Registration</h1>
                    <p class="mt-1 text-sm/6 text-gray-600">Create a new user account</p>
                        ...
                        <div class="sm:col-span-3">
                            ...
                            <div class="mt-2">
                                <input
                                    ...
                                    class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline outline-1 -outline-offset-1 <?= isset($errors['password_confirmation']) ? 'outline-red-500 focus:outline-red-500' : 'outline-gray-300 focus:outline-indigo-600' ?> placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 sm:text-sm/6"
                                />
                            </div>
                            <?php if (isset($errors['password_confirmation'])) : ?>
                                <p class="mt-2 text-sm text-red-600"><?= htmlspecialchars($errors['password_confirmation']) ?></p>
                            <?php endif; ?>
                        </div>
                    </div>
                </div>
                ...
                <div class="mt-6 flex items-center justify-end gap-x-6">
                    ...
                    <button type="submit" class="rounded-md bg-indigo-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Register</button>
                </div>
            </form>
        </div>
    </div>
