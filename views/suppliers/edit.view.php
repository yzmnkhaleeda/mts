...
<main>
    <div class="mx-auto max-w-7xl py-6 sm:px-6 lg:px-8">
        <div class="mx-auto max-w-4xl">
                    ...
                    <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <div class="mt-2">
                                <input
                                    ...
                                    name="industry_type"
                                    id="industry_type"
                                    value="<?= htmlspecialchars($_POST['industry_type'] ?? $supplier['industry_type'] ?? '') ?>"
                        ...
                        <div class="sm:col-span-3">
                            ...
                            <div class="mt-2">
                                <input
                                    ...
                                    name="company_phone"
                                    id="company_phone"
                                    value="<?= htmlspecialchars($_POST['company_phone'] ?? $supplier['company_phone'] ?? '') ?>"
                        ...
                        <div class="sm:col-span-3">
                            ...
                            <div class="mt-2">
                                <input
                                    ...
                                    name="company_email"
                                    id="company_email"
                                    value="<?= htmlspecialchars($_POST['company_email'] ?? $supplier['company_email'] ?? '') ?>"
                        ...
                        <div class="col-span-full">
                            ...
                            <div class="mt-2">
                                ...
                                ><?= htmlspecialchars($_POST['company_address'] ?? $supplier['company_address'] ?? '') ?></textarea>
                            </div>
                        ...
                        <div class="sm:col-span-2 sm:col-start-1">
                            ...
                            <div class="mt-2">
                                <input
                                    ...
                                    name="company_city"
                                    id="company_city"
                                    value="<?= htmlspecialchars($_POST['company_city'] ?? $supplier['company_city'] ?? '') ?>"
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <div class="mt-2">
                                <input
                                    ...
                                    name="company_state"
                                    id="company_state"
                                    value="<?= htmlspecialchars($_POST['company_state'] ?? $supplier['company_state'] ?? '') ?>"
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <div class="mt-2">
                                <input
                                    ...
                                    id="company_postcode"
                                    value="<?= htmlspecialchars($_POST['company_postcode'] ?? $supplier['company_postcode'] ?? '') ?>"
                        ...
                        <div class="sm:col-span-3">
                            ...
                            <div class="mt-2">
                                <input
                                    ...
                                    name="pic_name"
                                    id="pic_name"
                                    value="<?= htmlspecialchars($_POST['pic_name'] ?? $supplier['pic_name'] ?? '') ?>"
                        ...
                        <div class="sm:col-span-3">
                            ...
                            <div class="mt-2">
                                <input
                                    ...
                                    name="pic_phone"
                                    id="pic_phone"
                                    value="<?= htmlspecialchars($_POST['pic_phone'] ?? $supplier['pic_phone'] ?? '') ?>"
                        ...
                        <div class="col-span-full">
                            ...
                            <div class="mt-2">
                                <input
                                    ...
                                    name="pic_email"
                                    id="pic_email"
                                    value="<?= htmlspecialchars($_POST['pic_email'] ?? $supplier['pic_email'] ?? '') ?>"
                        ...
                        <div class="sm:col-span-3">
                            ...
                            <div class="mt-2">
                                <input
                                    ...
                                    id="brands_supplied"
                                    value="<?= htmlspecialchars($_POST['brands_supplied'] ?? $supplier['brands_supplied'] ?? '') ?>"
                        ...
                        <div class="sm:col-span-3">
                            ...
                            <div class="mt-2">
                                <input
                                    ...
                                    name="items_supplied"
                                    id="items_supplied"
                                    value="<?= htmlspecialchars($_POST['items_supplied'] ?? $supplier['items_supplied'] ?? '') ?>"
            ...
            <form action="/supplier" method="POST" class="flex justify-end mt-6">
