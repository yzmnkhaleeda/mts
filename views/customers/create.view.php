...
<main>
    <div class="mx-auto max-w-7xl py-6 sm:px-6 lg:px-8">
        <div class="mx-auto max-w-4xl">
            <form action="/customers/create" method="POST" class="space-y-12">
                        ...
                        <div class="sm:col-span-3">
                            ...
                            <div class="mt-2">
                                <input
                                    ...
                                    name="pic_position"
                                    id="pic_position"
                                    value="<?= htmlspecialchars($_POST['pic_position'] ?? '') ?>"
                    ...
                    <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                        ...
                        <div class="sm:col-span-3">
                            ...
                            <div class="mt-2">
                                ...
                                >
                                    ...
                                    <option value="Product" <?= ($_POST['category'] ?? '') === 'Product' ? 'selected' : '' ?>>Product</option>
                                    <option value="Service" <?= ($_POST['category'] ?? '') === 'Service' ? 'selected' : '' ?>>Service</option>
                        ...
                        <div class="col-span-full">
                            ...
                            <div class="mt-2">
                                ...
                                ><?= htmlspecialchars($_POST['category_details'] ?? '') ?></textarea>
                            </div>
                ...
                <div class="mt-6 flex items-center justify-end gap-x-6">
                    <a href="/customers" class="text-sm/6 font-semibold text-gray-900">Cancel</a>
