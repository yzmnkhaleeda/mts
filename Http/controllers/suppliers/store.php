...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $db->query(
        'INSERT INTO supplier (company_name, industry_type, company_address, company_city, company_state, company_postcode, company_phone, company_email, pic_name, pic_phone, pic_email, brands_supplied, items_supplied)
         VALUES (:company_name, :industry_type, :company_address, :company_city, :company_state, :company_postcode, :company_phone, :company_email, :pic_name, :pic_phone, :pic_email, :brands_supplied, :items_supplied)',
        [
